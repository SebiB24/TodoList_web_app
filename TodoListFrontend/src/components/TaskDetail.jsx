        ...
        <div className="task-detail-card">
            ...
            {task.status != TaskStatus.COMPLETE &&
                <div className="detail-actions">
                    <button className="complete-btn"> <FontAwesomeIcon icon={faCheck}></FontAwesomeIcon> Check</button>
                    <button className="edit-btn">Edit</button>
                    <button className="delete-btn"><FontAwesomeIcon icon={faTrash}></FontAwesomeIcon></button>
                </div>
            }
